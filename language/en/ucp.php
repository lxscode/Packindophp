...
$lang = array_merge($lang, array(
	'ACCOUNT_ACTIVE'				=> 'Nama pengguna Anda telah diaktifkan. Terima kasih sudah mendaftar.',
	'ACCOUNT_ACTIVE_ADMIN'			=> 'Nama pengguna ini telah diaktifkan.',
	'ACCOUNT_ACTIVE_PROFILE'		=> 'Nama pengguna Anda telah berhasil diaktifkan ulang.',
	'ACCOUNT_ADDED'					=> 'Terima kasih telah mendaftar, nama pengguna Anda telah didaftarkan. Anda bisa masuk dengan nama pengguna dan kata sandi Anda.',
	'ACCOUNT_COPPA'					=> 'Nama pengguna Anda telah didaftarkan tetapi belum disetujui, silahkan periksa e-mail Anda untuk lebih jelasnya.',
	'ACCOUNT_EMAIL_CHANGED'			=> 'Nama pengguna Anda telah diperbarui. Akan tetapi, halaman ini membutuhkan pengaktifan ulang nama pengguna dalam perubahan e-mail. Kunci pengaktifan telah dikirim ke alamat e-mail baru Anda. Silahkan periksa e-mail Anda untuk informasi lebih lengkap.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Nama pengguna Anda telah diperbarui. Akan tetapi, halaman ini membutuhkan pengaktifan nama pengguna kembali oleh administrator akibat perubahan e-mail yang anda lakuka. E-mail telah dikirim kepada mereka dan anda akan segera diinformasikan setelah nama anda diaktifkan kembali.',
	'ACCOUNT_INACTIVE'				=> 'Nama pengguna Anda telah didaftarkan. Akan tetapi, halaman ini membutuhkan pengaktifan nama pengguna, kunci pengaktifan telah dikirim ke alamat e-mail yang anda tentukan. Silahkan periksa e-mail anda untuk informasi lebih lanjut.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Nama pengguna Anda telah didaftarkan. Akan tetapi, halaman ini membutuhkan pengaktifan nama pengguna oleh grup administrator. E-mail telah dikirim kepada mereka dan anda akan segera diinformasikan setelah nama anda diaktifkan.',
	...
	'FIELD_TOO_SHORT'					=> array(
		1	=> 'Isian ini  “%2$s” terlalu pendek, karakter minimal yang diijinkan adalah %1$d.',
		2	=> 'Isian ini  “%2$s” terlalu pendek, karakter minimal yang diijinkan adalah %1$d.',
	),
	'FIELD_TOO_LONG'					=> array(
		1	=> 'Isian ini  “%2$s” terlalu panjang, karakter maksimal yang diijinkan adalah %1$d.',
		2	=> 'Isian ini  “%2$s” terlalu panjang, karakter maksimal yang diijinkan adalah %1$d.',
	),
	...
	'FIELD_INVALID_CHARS_INVALID'		=> 'Isian ini “%s” memiliki karakter yang tidak sah.',
	'FIELD_INVALID_CHARS_NUMBERS_ONLY'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya angka karakter yang diperbolehkan.',
	'FIELD_INVALID_CHARS_ALPHA_DOTS'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya teks, angka karakter yang diperbolehkan.',
	'FIELD_INVALID_CHARS_ALPHA_ONLY'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya karakter alphanumeric yang diijinkan.',
	'FIELD_INVALID_CHARS_ALPHA_PUNCTUATION'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya teks, angka karakter yang diperbolehkan.',
	'FIELD_INVALID_CHARS_ALPHA_SPACERS'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya karakter alphanumeric, spasi atau -+_[] yang diijinkan.',
	'FIELD_INVALID_CHARS_ALPHA_UNDERSCORE'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya teks, angka karakter yang diperbolehkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_DOTS'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya teks, angka, atau . karakter yang diperbolehkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_ONLY'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya teks, angka karakter yang diperbolehkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_PUNCTUATION'	=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya teks, angka karakter _ , dan karakter pertama harus alfabet yang diperbolehkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_SPACERS'		=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya teks, angka, spasi atau karakter -+_[] yang diperbolehkan.',
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'Isian ini “%s” memiliki karakter yang tidak sah, hanya teks, angka karakter _ yang diperbolehkan.',
	...
	'NOTIFICATIONS_MARK_ALL_READ'						=> 'Tandai semua notifikasi terbaca',
	'NOTIFICATIONS_MARK_ALL_READ_CONFIRM'				=> 'Apakah Anda yakin ingin semua notifikasi terbaca?',
	'NOTIFICATIONS_MARK_ALL_READ_SUCCESS'				=> 'Semua notifikasi telah ditandai terbaca.',
	'NOTIFICATION_GROUP_MISCELLANEOUS'					=> 'Miscellaneous Notifications',
	'NOTIFICATION_GROUP_MODERATION'						=> 'Notifikasi Moderasi',
	'NOTIFICATION_GROUP_ADMINISTRATION'					=> 'Notifikasi Administrasi',
	'NOTIFICATION_GROUP_POSTING'						=> 'Notifikasi Posting',
	'NOTIFICATION_METHOD_BOARD'							=> 'Notifikasi',
	'NOTIFICATION_METHOD_EMAIL'							=> 'Email',
	'NOTIFICATION_METHOD_JABBER'						=> 'Jabber',
	'NOTIFICATION_TYPE'									=> 'Tipe Notifikasi',
	'NOTIFICATION_TYPE_BOOKMARK'						=> 'Seseorang membalas di topik yang Anda bookmarked',
	'NOTIFICATION_TYPE_GROUP_REQUEST'					=> 'Seseorang meminta bergabung di grup yang Anda pimpin',
	'NOTIFICATION_TYPE_FORUM'							=> 'Seseorang membalas di topik yang Anda ikuti',
	'NOTIFICATION_TYPE_IN_MODERATION_QUEUE'				=> 'Sebuah pos atau topik perlu persetujuan',
	'NOTIFICATION_TYPE_MODERATION_QUEUE'				=> 'Pos atau topik Anda disetujui/tidak disetujui oleh moderator',
	'NOTIFICATION_TYPE_PM'								=> 'Seseorang mengirimkan pesan pribadi kepada Anda',
	'NOTIFICATION_TYPE_POST'							=> 'Seseorang membalas ke topik yang Anda ikuti',
	'NOTIFICATION_TYPE_QUOTE'							=> 'Seseorang mengutip Anda di sebuah pos',
	'NOTIFICATION_TYPE_REPORT'							=> 'Seseorang melaporkan pos',
	'NOTIFICATION_TYPE_REPORT_CLOSED'					=> 'Laporan Anda ditutup oleh moderator',
	'NOTIFICATION_TYPE_REPORT_PM'						=> 'Seseorang melaporkan chat pribadi',
	'NOTIFICATION_TYPE_REPORT_PM_CLOSED'				=> 'Laporan Anda di chat pribadi ditutup oleh moderator',
	'NOTIFICATION_TYPE_TOPIC'							=> 'Seseorang membuat topik baru dalam topik yang Anda ikuti',
	'NOTIFICATION_TYPE_ADMIN_ACTIVATE_USER'				=> 'Pengguna meminta aktivasi',
	...
	'PASS_TYPE_ALPHA_EXPLAIN'	=> 'Panjang kata sandi harus diantara %1$s karakter, harus mengandung pencampuran huruf besar dan kecil dan harus mengandung angka.',
	'PASS_TYPE_ANY_EXPLAIN'		=> 'Panjang kata sandi harus diantara %1$s karakter.',
	'PASS_TYPE_CASE_EXPLAIN'	=> 'Panjang kata sandi harus diantara %1$s karakter dan harus mengandung pencampuran huruf besar dan kecil.',
	'PASS_TYPE_SYMBOL_EXPLAIN'	=> 'Panjang kata sandi harus diantara %1$s karakter, harus mengandung pencampuran huruf besar dan kecil, harus mengandung angka dan harus mengandung angka symbol.',
	'PASSWORD'					=> 'Kata sandi',
