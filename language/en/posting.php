...
$lang = array_merge($lang, array(
	...
	'CHARS_POST_CONTAINS'		=> array(
		1	=> 'Pesan Anda mengandung %1$d karakter.',
		2	=> 'Pesan Anda mengandung %1$d karakter.',
	),
	'CHARS_SIG_CONTAINS'		=> array(
		1	=> 'Tanda tangan Anda mengandung %1$d karakter.',
		2	=> 'Tanda tangan Anda mengandung %1$d karakter.',
	),
	...
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> 'Anda yakin ingin menghapus <strong>permanen</strong> pos ini?',
	'DELETE_POST_PERMANENTLY'	=> array(
		1	=> 'Pos yang sudah dihapus permanen tidak dapat dikembalikan lagi',
		2	=> 'Pos %1$d dihapus permanen tidak dapat dikembalikan lagi',
	),
	'DELETE_POSTS_CONFIRM'		=> 'Anda yakin ingin menghapus pos ini?',
	'DELETE_POSTS_PERMANENTLY_CONFIRM'	=> 'Anda yakin ingin menghapus <strong>permanen</strong> pos ini?',
	'DELETE_REASON'				=> 'Alasan penghapusan',
	'DELETE_REASON_EXPLAIN'		=> 'Alasan penghapusan akan terlihat oleh moderator.',
	'DELETE_POST_WARN'			=> 'Hapus pos ini',
	'DELETE_TOPIC_CONFIRM'		=> 'Anda yakin ingin menghapus topik ini?',
	'DELETE_TOPIC_PERMANENTLY'	=> array(
		1	=> 'Topik yang sudah dihapus permanen tidak dapat dikembalikan lagi',
		2	=> 'Topik %1$d dihapus permanen tidak dapat dikembalikan lagi',
	),
	'DELETE_TOPIC_PERMANENTLY_CONFIRM'	=> 'Anda yakin ingin menghapus <strong>permanen</strong> topik ini?',
	'DELETE_TOPICS_CONFIRM'		=> 'Anda yakin ingin menghapus topik ini?',
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'	=> 'Anda yakin ingin menghapus <strong>permanen</strong> topik ini?',
	...
	'LOGIN_EXPLAIN_SOFT_DELETE'	=> 'Anda harus masuk untuk menghapus post-post di dalam forum ini.',
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> array(
		...
		2	=> 'Tinggi ukuran file flash anda hanya diperbolehkan sampai %1$d piksel.',
	),
	'MAX_FLASH_WIDTH_EXCEEDED'	=> array(
		1	=> 'Lebar ukuran file flash anda hanya diperbolehkan sampai %1$d piksel.',
		2	=> 'Lebar ukuran file flash anda hanya diperbolehkan sampai %1$d piksel.',
	),
	'MAX_IMG_HEIGHT_EXCEEDED'	=> array(
		1	=> 'Tinggi ukuran gambar anda hanya diperbolehkan sampai  %1$d piksel.',
		2	=> 'Tinggi ukuran gambar anda hanya diperbolehkan sampai  %1$d piksel.',
	),
	'MAX_IMG_WIDTH_EXCEEDED'	=> array(
		1	=> 'Lebar ukuran gambar anda hanya diperbolehkan sampai %1$d piksel.',
		2	=> 'Lebar ukuran gambar anda hanya diperbolehkan sampai %1$d piksel.',
	),

	'MESSAGE_BODY_EXPLAIN'		=> array(
		0	=> '', // zero means no limit, so we don't view a message here.
		1	=> 'Masukkan pesan anda disin, pesan anda tidak boleh melebihi <strong>%d</strong> karakter.',
		2	=> 'Masukkan pesan anda disin, pesan anda tidak boleh melebihi <strong>%d</strong> karakter.',
	),
	...
	'NO_TEMP_DIR'				=> 'Folder sementara tidak ada atau tidak terbaca.',
	...
	'POLL_OPTIONS_EXPLAIN'		=> array(
		1	=> 'Tempatkan setiap pilihan pada baris baru. Anda hanya dapat memasukkan pilihan sampai <strong>%d</strong> pilihan.',
		2	=> 'Tempatkan setiap pilihan pada baris baru. Anda hanya dapat memasukkan pilihan sampai <strong>%d</strong> pilihan.',
	),
	'POLL_OPTIONS_EDIT_EXPLAIN'		=> array(
		1	=> 'Tempatkan setiap pilihan pada baris baru. Anda hanya dapat memasukkan pilihan sampai <strong>%d</strong> pilihan. Jika anda membuang atau menambah pilihan maka semua suara akan diulangi.',
		2	=> 'Tempatkan setiap pilihan pada baris baru. Anda hanya dapat memasukkan pilihan sampai <strong>%d</strong> pilihan. Jika anda membuang atau menambah pilihan maka semua suara akan diulangi.',
	),
	...
	'QUOTE_DEPTH_EXCEEDED'		=> array(
		1	=> 'Anda hanya boleh menggunakan %1$d kutipan dengan yang lainnya.',
		2	=> 'Anda hanya boleh menggunakan %1$d kutipan dengan yang lainnya.',
	),
	'QUOTE_NO_NESTING'			=> 'Anda tidak boleh menggunakan kutipan dengan yang lainnya.',

	'REMOTE_UPLOAD_TIMEOUT'		=> 'Berkas Anda tidak dapat diunggah karena waktu permintaan habis.',
	'SAVE'						=> 'Simpan',
	...
	'TOO_FEW_CHARS_LIMIT'		=> array(
		1	=> 'Jumlah minimum karakter yang harus anda masukkan adalah %1$d karakter.',
		2	=> 'Jumlah minimum karakter yang harus anda masukkan adalah %1$d karakter.',
	),
	...
	'TOO_MANY_CHARS_LIMIT'		=> array(
		2	=> 'Jumlah maksimum karekter yang diijinkan adalah %1$d.',
	),
	...
	'UNSUPPORTED_CHARACTERS_MESSAGE'	=> 'Pesan Anda mengandung karakter yang tidak diperbolehkan:<br />%s',
	'UNSUPPORTED_CHARACTERS_SUBJECT'	=> 'Subjek Anda mengandung karakter yang tidak diperbolehkan:<br />%s',
